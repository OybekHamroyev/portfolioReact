...
class App extends PureComponent {        //PureComponent ortiqcha rendering bajarilmaydi, shouldComponentUpdate(lifecycle) ishlatmaganda foydalaniladi, dastur tezroq ishlaydi
    constructor(props) {
        super(props);
    ...
    componentDidMount(){
        ...
        .then(data=>{
           let jsonData=eval('('+ data +')'); //eslint-disable-line(eval-bu fya. chunki data objectlar qatori kurinishida
                                                // '('+ data +')' bunday yozilsa warning chiqmas emish)
